...
const translations = {
  mk: {
    ...
    hero_subtitle: "Персонализирани третмани што го решаваат коренот на проблемот, не само симптомите. 50+ задоволни клиенти во Скопје.",
    ...
    process_2_text: "Правам темелна физичко тестирање за да го најдам коренот на проблемот.",

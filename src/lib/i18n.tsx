...
const translations = {
  mk: {
    ...
    hero_subtitle: "Персонализирани третмани што го решаваат коренот на проблемот, не само симптомите.",
    hero_stats: "50+ задоволни клиенти во Скопје.",
    hero_cta: "Закажете Консултација",
    testimonials_title: "Што Велат Нашите Клиенти",
    testi_1_text: "После еден третман болките во грбот ми ги снема.",
    ...
    why_1_text: "Ниту еден третман не е ист. Секој план е направен според вашите потреби.",
    why_2_title: "Коректно дијагностицирање",
    why_2_text: "Не третираме само болка — наоѓаме зошто се случува и го решаваме тоа.",
    why_3_title: "Реални Резултати",
    why_3_text: "Повеќето клиенти чувствуваат подобрување за 2-3 сесии, не месеци.",
    about_title: "За Иво Талески",
    about_bio: "Веќе 4 години им помагам на луѓето да се движат подобро, да го подобрат квалитетот на живот и да се вратат во форма. Комбинирам современи физиотерапевтски техники со длабоко разбирање на тоа како вашето тело навистина функционира.",
    cred_1: "Дипломиран физиотерапевт",
    cred_3: "Киропрактика, cupping, taping",
    cred_4: "4+ години искуство",
    process_title: "Како Работи?",
    process_1_title: "Консултација",
    process_1_text: "Разговараме за вашата болка, историја и цели.",
    process_2_title: "Детална Анализа",
    process_2_text: "Правам темелнo физичко тестирање за да го најдам коренот на проблемот.",
    ...
    final_cta_title: "Направете го првиот чекор за решавање на вашиот проблем",
  ...
  en: {
    ...
    hero_subtitle: "Personalized treatments that solve the root cause, not just symptoms.",
    hero_stats: "Over 50+ satisfied clients in Skopje.",
    ...
    process_2_text: "I perform a thorough physical assessment to find the root cause.",
    ...
    final_cta_title: "Take the First Step Towards Pain-Free Movement",
